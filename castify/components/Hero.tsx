  ...
  return (
    <article className="w-full flex items-center justify-between bg-violet-50 shadow-md rounded-lg pl-4 pr-0 md:px-8 lg:pr-5 xl:px-16">
      <section className="flex flex-col py-3 md:py-0">
        ...
        <Button
          asChild
          className="mt-5 lg:mt-10 w-fit px-2 md:px-4 lg:px-6 lg:py-6 text-[0.6rem] md:text-sm lg:text-lg font-semibold bg-[var(--button-primary)] hover:bg-[var(--button-primary-hover)]"
        >
          <Link href="/explore">
            Explore shows{" "}
            <ChevronRight
